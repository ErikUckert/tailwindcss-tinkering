                ...
                <div className="px-8 py-12 max-w-md mx-auto sm:max-w-xl lg:px-12 lg:py-24 lg:max-w-full xl:mr-0 2xl:col-span-2">
                    <div className="xl:max-w-xl">
                        ...
                        <div className="mt-4 space-x-1 sm:mt-6">
                            <a className="inline-block px-5 py-3 rounded-lg transform transition bg-indigo-500 
                                hover:bg-indigo-400 hover:-translate-y-0.5 focus:ring-indigo-500 focus:ring-opacity-50 focus:outline-none 
                                focus:ring focus:ring-offset-2 active:bg-indigo-600 uppercase tracking-wider font-semibold text-sm 
                ...
                <div className="mt-6 grid gap-6 lg:grid-cols-2 xl:grid-cols-3">
                    ...
                    {popularDestinations.map(destination => (
                        <div className="flex items-center rounded-lg bg-white shadow-lg overflow-hidden">
                            <img className="h-32 w-32 object-cover object-center" src={destination.imageUrl} alt={destination.imageAlt} />
